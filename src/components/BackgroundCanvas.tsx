...
export default function BackgroundCanvas() {
  ...
  useEffect(() => {
    ...
    if (!gl) {
      console.warn("MM8_SYSTEM_NOTICE: WebGL not supported or context lost. Falling back to static background.");
      setWebglError(true);
    }
    ...
    <div className="fixed inset-0 -z-10 bg-black pointer-events-none overflow-hidden">
      {!webglError ? (
        <Canvas 
          ...
          onError={() => {
            console.error("MM8_WEBGL_CRITICAL: Context lost during runtime. Triggering fallback.");
            setWebglError(true);
          }}
        >
